...
export interface LandingPage {
  slug: string;
  /** Only set when a real (or example) case study exists to link to. */
  projectSlug?: string;
  image: string;
  industry: string;
  industryEs: string;
...
export const LANDING_PAGES: LandingPage[] = [
  ...
  },
  {
    ...
    metaTitleEs:
      "Diseño de Sitios Web para Distribuidores e Importadores B2B — Fen Web Studio",
    metaDescription:
      "A catalog-and-quote website for distributors and importers, built around how B2B buyers actually decide — so RFQs stop happening over email and spreadsheets. See how we did it for a multi-brand lubricant importer.",
    metaDescriptionEs:
      "Un sitio de catálogo y cotización para distribuidores e importadores, construido alrededor de cómo compran realmente los clientes B2B — para que las cotizaciones dejen de pasar por correo y hojas de cálculo. Mira cómo lo hicimos para un importador multimarca de lubricantes.",
    ...
    intro:
      "Most B2B buyers decide who to call before anyone picks up the phone — by checking whether a supplier's site actually shows what they carry, what the minimums are, and how to request pricing. We build sites around that decision, not a generic 'About Us' template.",
    introEs:
      "La mayoría de los compradores B2B deciden a quién llamar antes de que alguien conteste el teléfono — revisando si el sitio del proveedor realmente muestra qué manejan, cuáles son los mínimos, y cómo pedir precio. Construimos sitios alrededor de esa decisión, no de un template genérico de 'Quiénes somos'.",
    painPoints: [
      {
        ...
        bodyEs:
          "Un comprador que compara proveedores quiere ver qué manejas en dos minutos, no pedir un PDF y esperar respuesta.",
      },
      {
        ...
        bodyEs:
          "Sin un formulario estructurado, cada trato empieza con el mismo ida y vuelta: qué necesitas, cuánto, para cuándo.",
      },
      {
        ...
        bodyEs:
          "Los compradores se autodescalifican en silencio cuando no pueden saber si su volumen o plazo encaja con tu modelo.",
      },
    ],
    approachPoints: [
      {
        ...
        bodyEs:
          "Cada marca o línea de producto tiene su propia sección en vez de una sola lista larga y sin diferenciar.",
      },
      {
        ...
        bodyEs:
          "Un formulario capta lo que un comprador realmente necesita especificar — no una caja genérica de 'contáctanos'.",
      },
      {
        title: "A monthly care plan",
        titleEs: "Un plan de cuidado mensual",
        ...
        bodyEs:
          "Nuevas líneas de producto, páginas de precios actualizadas y cambios al catálogo — resueltos sin una factura de rediseño.",
      },
    ],
  ...
  },
  {
    ...
    metaTitleEs:
      "Diseño de Sitios Web para Contratistas y Servicios para el Hogar — Fen Web Studio",
    metaDescription:
      "A website that gets a contractor found, trusted, and called — built once, kept current every month. No page builder, no plugins, no monthly login required on your end.",
    metaDescriptionEs:
      "Un sitio web que hace que te encuentren, confíen en ti y te llamen — construido una vez, mantenido al día cada mes. Sin constructor visual, sin plugins, sin necesidad de entrar a nada de tu lado.",
    ...
    intro:
      "Most contractor sites exist because someone said they needed one — not because they actually bring in work. We build sites around the two things that matter: proof you do good work, and a way to reach you that doesn't require a phone tag.",
    introEs:
      "La mayoría de los sitios de contratistas existen porque alguien dijo que hacía falta uno — no porque realmente traigan trabajo. Construimos sitios alrededor de lo que importa: evidencia de que haces buen trabajo, y una forma de contactarte sin jugar al teléfono.",
    painPoints: [
      {
        ...
        bodyEs:
          "Un dueño de casa que compara tres contratistas elige al que se ve como que ya ha hecho el trabajo antes.",
      },
      {
        ...
        bodyEs:
          "Algunos clientes no llaman en horario laboral — un formulario simple capta a los que una llamada perdida deja ir.",
      },
      {
        ...
        bodyEs:
          "Fotos de proyectos viejos y una zona de servicio desactualizada pierden trabajos en silencio frente a competidores con un sitio al día.",
      },
    ],
    approachPoints: [
      {
        ...
        bodyEs:
          "El trabajo habla por sí mismo en vez de esconderse detrás de una imagen genérica de stock.",
      },
      {
        ...
        bodyEs:
          "Un cliente que escribe un domingo a las 9pm sigue siendo un cliente — el sitio debe poder recibirlo.",
      },
      {
        title: "A monthly care plan",
        titleEs: "Un plan de cuidado mensual",
        ...
        bodyEs:
          "Fotos nuevas de proyectos, zonas de servicio actualizadas y pequeños cambios — resueltos sin que toques ningún código.",
      },
    ],
  },
  {
    ...
    metaDescription:
      "Your first website, done right the first time — a small, credible site built around what your business actually needs, with a plan to keep it current as you grow.",
    metaDescriptionEs:
      "Tu primer sitio web, bien hecho desde el inicio — un sitio pequeño y creíble construido alrededor de lo que tu negocio realmente necesita, con un plan para mantenerlo al día conforme creces.",
    ...
    intro:
      "A first website doesn't need fifteen pages and a blog nobody will write. It needs to say what you do, prove you're legitimate, and give people a clear way to reach you — built on something you won't have to rebuild from scratch in two years.",
    introEs:
      "Un primer sitio web no necesita quince páginas y un blog que nadie va a escribir. Necesita decir qué haces, demostrar que eres legítimo, y dar una forma clara de contactarte — construido sobre algo que no tendrás que rehacer desde cero en dos años.",
    painPoints: [
      {
        ...
        bodyEs:
          "Los constructores gratuitos cargan lento, se ven genéricos y a veces traen anuncios o marca ajena pegada.",
      },
      {
        ...
        bodyEs:
          "La mayoría de los negocios nuevos construyen muy poco — sin forma de contactarlos — o demasiado, persiguiendo funciones que nadie va a usar todavía.",
      },
      {
        ...
        bodyEs:
          "Un sitio que nunca se actualiza después de la primera semana empieza a verse abandonado a los seis meses.",
      },
    ],
    approachPoints: [
      {
        ...
        bodyEs:
          "Unas pocas secciones claras en vez de un template con páginas que nunca vas a llenar.",
      },
      {
        ...
        bodyEs:
          "Una construcción real en Next.js en vez de un template de constructor visual — se agregan páginas nuevas conforme crece el negocio, sin rehacer todo desde cero.",
      },
      {
        ...
        bodyEs:
          "Pequeños cambios y actualizaciones resueltos conforme creces, en vez de una factura de rediseño más adelante.",
      },
    ],
  },
  {
    ...
    metaDescription:
      "A redesign for a website that no longer represents the business — same domain, same content you actually need, rebuilt to load fast and look current.",
    metaDescriptionEs:
      "Un rediseño para un sitio que ya no representa al negocio — mismo dominio, mismo contenido que realmente necesitas, reconstruido para cargar rápido y verse actual.",
    ...
    intro:
      "An old website usually isn't broken, it's just stopped representing the business it belongs to. We rebuild it on something faster and easier to maintain, keep what actually works, and cut what was only ever there because a template shipped with it.",
    introEs:
      "Un sitio viejo casi nunca está roto, solo dejó de representar al negocio al que pertenece. Lo reconstruimos sobre algo más rápido y fácil de mantener, conservamos lo que sí funciona, y quitamos lo que solo estaba ahí porque venía con el template.",
    painPoints: [
      {
        ...
        bodyEs:
          "Tipografía, layout y fotos que sin querer dan a entender que el negocio no se ha actualizado — aunque el trabajo sí lo haya hecho.",
      },
      {
        ...
        bodyEs:
          "Años de complementos sobre un constructor viejo se acumulan en un sitio que tarda segundos de más en cargar.",
      },
      {
        ...
        bodyEs:
          "La persona que lo construyó ya no está, y cada cambio pequeño ahora significa buscar a alguien nuevo.",
      },
    ],
    approachPoints: [
      {
        ...
        bodyEs:
          "Sin perder historial de SEO, sin migración confusa para clientes que regresan — misma dirección, mejor sitio.",
      },
      {
        ...
        bodyEs:
          "Construido en Next.js en vez de un constructor visual heredado — sin plugins que mantener, sin panel lento.",
      },
      {
        title: "A monthly care plan",
        titleEs: "Un plan de cuidado mensual",
        ...
        bodyEs:
          "Para que el sitio nuevo no envejezca en silencio de la misma forma que el anterior.",
      },
    ],
  },
  {
    ...
    metaDescription:
      "A website you're not responsible for keeping alive — no CMS login, no plugin updates, no page-builder subscription. Small changes handled for you every month instead.",
    metaDescriptionEs:
      "Un sitio web del que no eres responsable de mantener vivo — sin entrar a ningún CMS, sin actualizar plugins, sin suscripción a un constructor visual. Los cambios pequeños se resuelven por ti cada mes.",
    ...
    intro:
      "Not every business owner wants to learn a CMS, and they shouldn't have to. We build the site, then handle the small stuff every month — text changes, new photos, a fixed typo — so it stays current without becoming one more account you have to log into.",
    introEs:
      "No todo dueño de negocio quiere aprender a usar un CMS, y no debería tener que hacerlo. Construimos el sitio, y luego nos encargamos de lo pequeño cada mes — cambios de texto, fotos nuevas, una errata corregida — para que se mantenga al día sin volverse una cuenta más en la que tienes que entrar.",
    painPoints: [
      {
        ...
        bodyEs:
          "Incluso un constructor 'simple' significa aprender una interfaz, y volver a aprenderla cada vez que cambia.",
      },
      {
        ...
        bodyEs:
          "Una actualización que se pasa puede tumbar el sitio, o dejar un hueco de seguridad, sin que nadie se dé cuenta por semanas.",
      },
      {
        ...
        bodyEs:
          "Un cambio de una línea de texto no debería requerir buscar a un freelancer o recordar una contraseña de hace dos años.",
      },
    ],
    approachPoints: [
      {
        ...
        bodyEs:
          "Sin ecosistema de plugins que mantener, sin panel de administración que asegurar — el sitio es rápido, estático y simple por dentro.",
      },
      {
        ...
        bodyEs:
          "Cambios de texto, fotos nuevas, ajustes pequeños — se envían, se resuelven, listo, como parte del plan de cuidado.",
      },
      {
        ...
        bodyEs:
          "Una línea directa con quien realmente construyó el sitio, en vez de una mesa de ayuda genérica.",
      },
    ],
  },
  {
    ...
    metaTitleEs:
      "Diseño de Sitios Web para Centros de Entrenamiento y Clubes Deportivos — Fen Web Studio",
    metaDescription:
      "A booking-first website for training centers, clubs, and coaches — turn levels, schedules, and locations into something people can book themselves. See how we did it for an adult soccer training club.",
    metaDescriptionEs:
      "Un sitio centrado en reservas para centros de entrenamiento, clubes y entrenadores — convierte niveles, horarios y sedes en algo que la gente pueda reservar sola. Mira cómo lo hicimos para un club de entrenamiento de fútbol para adultos.",
    ...
    intro:
      "Most training centers run a real system — levels, schedules, locations — that nobody outside the group ever sees. A prospective member has to message around to figure out where they fit. We build sites that do that sorting up front, so the first message someone sends is 'I'm in,' not 'which one is for me?'",
    introEs:
      "La mayoría de los centros de entrenamiento manejan un sistema real — niveles, horarios, sedes — que nadie fuera del grupo llega a ver. Un posible integrante tiene que preguntar por su cuenta para saber dónde encaja. Construimos sitios que hacen esa clasificación desde el inicio, para que el primer mensaje que alguien mande sea 'me apunto', no '¿cuál es para mí?'",
    painPoints: [
      {
        ...
        bodyEs:
          "Cada integrante nuevo empieza con el mismo ida y vuelta por WhatsApp o Instagram que el sitio ya debería estar respondiendo.",
      },
      {
        ...
        bodyEs:
          "Manejar varios grupos, niveles o sedes a través de una sola página genérica de 'contáctanos' deja a la gente adivinando cuál es la suya.",
      },
      {
        ...
        bodyEs:
          "Alguien que considera un club o equipo nuevo quiere ver entrenamientos y coaches reales antes de presentarse — no una foto de stock de un balón.",
      },
    ],
    approachPoints: [
      {
        ...
        bodyEs:
          "Niveles, horarios y sedes presentados con la claridad suficiente para que la gente se ubique sola, sin escribir primero.",
      },
      {
        ...
        bodyEs:
          "Un solo camino claro para convertir el interés en una primera sesión — no una caja de contacto estática que cae en una fila.",
      },
      {
        title: "A monthly care plan",
        titleEs: "Un plan de cuidado mensual",
        ...
        bodyEs:
          "Horarios, niveles y sedes cambian de temporada en temporada — se actualizan por ti en vez de esperar a un rediseño.",
      },
    ],
